...
# Arquivo aonde está armazenado o select do banco.
...
def connOra(user, password, host, select_ora):
    ...
    # Fimitando a quantidade de linhas que vem do banco para a variavel
    cursor.prefetchrows = 1000
    cursor.arraysize = 1000

    # Faz a checagem do tip da conexão e caso seja do typo CLOB retorna os dados em tipo STRING
